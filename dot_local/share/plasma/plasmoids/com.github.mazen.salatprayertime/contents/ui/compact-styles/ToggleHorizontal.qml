...
RowLayout {
    ...
    Label {
        ...
        text: compactRoot ? (compactRoot.toggleViewIsPrayerTime ? compactRoot.nextPrayerName : compactRoot.getCompactRemainingWord()) : ""
    }
    ...
    Label {
        ...
        text: compactRoot ? (compactRoot.toggleViewIsPrayerTime ? compactRoot.nextPrayerTime : compactRoot.countdownText.substring(0, 5)) : ""
    }
}
